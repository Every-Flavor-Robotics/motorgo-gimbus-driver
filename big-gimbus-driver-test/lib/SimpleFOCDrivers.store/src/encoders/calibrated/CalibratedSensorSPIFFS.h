#ifndef __CALIBRATEDSENSORSPIFFS_H__
#define __CALIBRATEDSENSORSPIFFS_H__
...
public:
    struct CalibrationData {
        float lut[200]; // Use a fixed size or manage dynamic size carefully
        float zero_electric_angle;
        int sensor_direction; // Store as int (1 or -1)
    };
...
public:
    ...
    */
    ...
    bool saveCalibration(FOCMotor& motor);
    bool loadCalibration(FOCMotor& motor);
